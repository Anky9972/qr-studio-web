...
export default function DashboardLayout({
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full bg-zinc-900 backdrop-blur-xl border-r border-zinc-800">
      {/* Logo */}
      <div className="h-16 flex items-center px-6 border-b border-zinc-800">
        <Link href="/dashboard" className="flex items-center gap-3 group translate-y-0.5">
          ...
          <div>
            <h1 className="text-lg font-bold font-display bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 group-hover:to-electric-cyan transition-all">
              QR Studio
            </h1>
      ...
      <div className="p-4 border-t border-zinc-800 bg-white/5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-electric-violet to-electric-blue flex items-center justify-center text-white font-bold ring-2 ring-black">
            {session.user?.image ? (
  ...
  return (
    <div className="min-h-screen bg-zinc-950 transition-colors duration-300">
      ...
      <div className={cn(
        ...
        {/* Top Header */}
        <header className="sticky top-0 z-30 h-16 bg-zinc-900/80 backdrop-blur-xl border-b border-zinc-800 px-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button
              onClick={() => setMobileOpen(true)}
              className="p-2 -ml-2 rounded-lg text-gray-300 hover:bg-white/10 md:hidden"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative ml-2">
              <button
                ...
                className="flex items-center gap-2 p-1 rounded-full border border-zinc-800 hover:bg-white/5 transition-all"
              >
              ...
              {isProfileOpen && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-2 w-56 bg-zinc-900 border border-zinc-800 rounded-xl shadow-xl z-50 py-2 animate-in fade-in slide-in-from-top-2">
