      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <Button size="lg" variant="outline" className="text-lg px-8 py-6 bg-transparent border-white/20 text-white hover:bg-white/10" asChild>
              <Link href="/use-cases">
                View Use Cases
              </Link>
            </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-blue-900/50 to-purple-900/50 rounded-3xl p-12 text-center border border-white/10 relative overflow-hidden max-w-4xl mx-auto">
            ...
            <div className="relative z-10">
              ...
              <Button size="lg" variant="premium" className="px-8 h-12 text-lg" asChild>
                <Link href="/signup">
                  Get Started Free
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
